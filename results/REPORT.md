# 20 Newsgroups benchmark — TF-IDF vs LM embeddings vs Jev
...
- The TF-IDF and embedding methods are **supervised**: they train on the labelled train split. Jev is used **zero-shot** on the same test set.
